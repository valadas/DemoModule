...
class Build : NukeBuild
{
    ...
    private string prodViewsPath = "/DesktopModules/DemoModule/resources/scripts/dnn-demomodule/";
    ...
    Target DeployFrontEnd => _ => _
        ...
        .Executes(() =>
        {
            var scriptsDestination = RootDirectory / "resources" / "scripts" / "dnn-demomodule";
            EnsureCleanDirectory(scriptsDestination);
            CopyDirectoryRecursively(RootDirectory / "module.web" / "dist" / "dnn-demomodule", scriptsDestination, DirectoryExistsPolicy.Merge);
        });
    ...
    Target Swagger => _ => _
        ...
        .Executes(() =>
        {
            ...
            NSwagTasks.NSwagWebApiToOpenApi(c => c
                .AddAssembly(RootDirectory / "bin" / Configuration / "DnnSummit.Modules.DemoModule.dll")
                .SetInfoTitle("Dnn Summit Demo Module")
