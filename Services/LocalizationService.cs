...
namespace DnnSummit.Modules.DemoModule.Services
{
    ...
    using static DnnSummit.Modules.DemoModule.ViewModels.LocalizationViewModel;
    ...
    public class LocalizationService : ILocalizationService
    {
            ...
            get
            {
                if (string.IsNullOrWhiteSpace(this.resourceFileRoot))
                {
                    this.resourceFileRoot = HostingEnvironment.MapPath(
                        "~/DesktopModules/DemoModule/resources/App_LocalResources/");
                }
        ...
        public LocalizationService()
        {
            ...
            this.cacheKey = "DnnSummit.Modules.DemoModule" + "_Localization_" + Thread.CurrentThread.CurrentCulture;
